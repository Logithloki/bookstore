...
<head>
    ...
    <title>Add New Book - Book Hive</title>
    ...
    <main class="min-h-screen py-12">
        <div class="max-w-4xl mx-auto px-6">
            ...
            <div class="text-center mb-12">
                <h1 class="text-4xl font-bold text-gray-800 mb-4">Add Your Book</h1>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                    Share your books with the BookHive community. Whether you want to sell, rent, or exchange, 
                    we'll help you connect with fellow book lovers.
                </p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <form action="{{ route('admin.books.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">                        <!-- Price Field (for Sell) -->
                        ...
                        <div id="rental-days-field" style="display: none;">
                            ...
                            <input type="number" 
                                   ...
                                   id="rental_days" 
                                   name="rental_days" 
                                   value="{{ old('rental_days') }}" 
                                   min="1"
                                   placeholder="7">
                        </div>

                        <!-- Exchange Category Field (for Exchange) -->
                        <div id="exchange-category-field" style="display: none;">
